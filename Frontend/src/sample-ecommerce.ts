...
// Export Dimension type if it's locally defined
export type { Dimension, DateDimension, Attribute, BrandDimension, CategoryDimension, CommerceDimension, CountryDimension };
